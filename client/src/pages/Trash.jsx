...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Do you want to permanently delete all projects?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Do you want to restore all projects in the trash?");
    setOpenDialog(true);
  };
  ...
  const deleteClick = (id) => {
    setType("delete");
    setSelected(id);
    setMsg("Do you want to permanently delete the selected project?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Do you want to restore the selected project?");
    setOpenDialog(true);
  };
      ...
      <div className='w-full md:px-1 px-0 mb-6'>
        ...
        {data?.tasks?.length > 0 ? (
          ...
          <div className='w-full flex justify-center py-10'>
            <p className='text-lg text-gray-500'>No projects in trash</p>
          </div>
        )}
      </div>
